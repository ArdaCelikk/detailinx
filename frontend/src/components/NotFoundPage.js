        ...
        <section class="px-4 py-32 mx-auto max-w-7xl">
            <div class="w-full mx-auto lg:w-1/3">
                <a href="#" title="Hellonext Home Page" class="flex items-center">
                    ...
                    <span class="sr-only">DetailinX Anasayfa</span>
                </a>
                <p class="mt-5 mb-3 text-xl font-bold text-black md:text-2xl">Sayfa Bulunamadı (404)</p>
                <p class="mb-3 text-base font-medium text-gray-700">
                    Aradığınız sayfa bulunamadı ya da artık mevcut değil. Ana sayfaya dönmek için <a href="#" class="underline">tıklayın </a> veya aşağıdaki bölümlerden birini inceleyin.
                </p>
            </div>
        </section>
    )
