...
const Navbar = (e) => {
    ...
    return (
        <header class=" absolute top-0 left-0 z-10 w-full">
            <nav class="mx-auto flex max-w-8xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    <div class="relative">
                        ...
                        <div style={{ zIndex: placeOfElement ? "999" : "-999" }} class={`${flyout ? "opacity-100 translate-y-0" : "opacity-0 translate-y-1"} transition ease-out duration-200 absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5`}>
                            <div class="p-4" >
